...
import { getRecipesRandom, getRecipeLike } from "../../API/products.js";
//import "../../assets/css/dashboard.css";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";

const EndPointSpoonacular = () => {
  ...
  const fetchRecetasAleatorias = async () => {
    ...
    await getRecipesRandom(
      (response) => {
        ...
        state.platos = response.data.recipes;
    ...
    await getRecipeLike(
      ...
      (response) => {
        ...
        if (response.data.results.length > 0) {
          state.platos = response.data.results;
          AlertSwal(
            "success",
            "Carga exitosa",
  ...
  const SearchPlatos = () => {
    const formik = useFormik({
      ...
      onSubmit: (values) => {
        ...
        fetchRecetasLike("query", values.search);
      },
    });
    return (
          ...
          <div class="col align-middle">
            <div class="form-check ">
              <input
                ...
                onClick={() => fetchRecetasLike("diet", "vegan")}
              />
          ...
          <div class="col">
            <div class="form-check">
              <input
                ...
                type="radio"
                class="form-check-input fs-3"
                onClick = {() => fetchRecetasLike("query", "no vegan")}
              />
...
export default EndPointSpoonacular;